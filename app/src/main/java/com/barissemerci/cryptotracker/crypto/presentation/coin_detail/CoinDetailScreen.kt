...
package com.barissemerci.cryptotracker.crypto.presentation.coin_detail
...
import com.barissemerci.cryptotracker.crypto.presentation.coin_detail.components.InfoCard
import com.barissemerci.cryptotracker.crypto.presentation.coin_list.CoinListState
import com.barissemerci.cryptotracker.crypto.presentation.coin_list.components.previewCoin
import com.barissemerci.cryptotracker.crypto.presentation.models.toDisplayableNumber
import com.barissemerci.cryptotracker.ui.theme.CryptoTrackerTheme
import com.barissemerci.cryptotracker.ui.theme.greenBackground
    ...
    if (state.isLoading) {
        ...
        Column(
            ...
            FlowRow(
                ...
                val contentColorLastInfo = if (isPositive) {
                ...
                InfoCard(
                    ...
                    contentColor = contentColorLastInfo
                )
