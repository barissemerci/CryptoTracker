package com.barissemerci.cryptotracker.crypto.presentation.coin_detail.components
...
fun InfoCard(
    ...
    Card(
        ...
        AnimatedContent(
            targetState = icon,
            modifier = Modifier.align(Alignment.CenterHorizontally), label = "IconAnimation"
        ) { icon ->
            Icon(
                imageVector = icon,
